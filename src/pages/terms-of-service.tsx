...
export default function TermsOfService() {
    return (
        <div>
            ...
            <p>7. MOBILE APPLICATION LICENSE</p>
            <p>8. SUBMISSIONS</p>
            <p>9. THIRD-PARTY WEBSITE AND CONTENT</p>
            <p>10. SITE MANAGEMENT</p>
            <p>11. PRIVACY POLICY </p>
            <p>12. TERM AND TERMINATION</p>
            <p>13. MODIFICATIONS AND INTERRUPTIONS</p>
            <p>14. GOVERNING LAW</p>
            <p>15. DISPUTE RESOLUTION</p>
            <p>16. CORRECTIONS</p>
            <p>17. DISCLAIMER</p>
            <p>18. LIMITATIONS OF LIABILITY</p>
            <p>19. INDEMNIFICATION</p>
            <p>20. USER DATA</p>
            <p>21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
            ...
            <div>
                <p>
                    ...
                    behalf of an entity (“you”) and Codelance GmbH (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot;
                    or &quot;our&quot;), concerning your access to and use of the https://www.codelance.ch/ website as
                    well as any other media form, media channel, mobile website or mobile application related, linked,
                    or otherwise connected thereto (collectively, the “Site”). We are registered in Switzerland and have
                    our registered office at Kirchgasse 3, Baar, Zug 6340. You agree that by accessing the Site, you
                    have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH
                ...
                <p>
                    ...
                    Site. If you are a minor, you must have your parent or guardian read and agree to these Terms of Use
            ...
            <p>
                <p>
                    ...
                    if a minor, you have received parental permission to use the Site; (3) you will not access the Site
                    through automated or non-human means, whether through a bot, script, or otherwise; (4) you will not
                    use the Site for any illegal or unauthorized purpose; and (5) your use of the Site will not violate
            ...
            <ul>Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.</ul>
            <ul>Use any information obtained from the Site in order to harass, abuse, or harm another person.</ul>
            <ul>Make improper use of our support services or submit false reports of abuse or misconduct.</ul>
            <ul>Use the Site in a manner inconsistent with any applicable laws or regulations.</ul>
            <ul>Engage in unauthorized framing of or linking to the Site.</ul>
            <ul>
            ...
            <ul>Delete the copyright or other proprietary rights notice from any Content.</ul>
            <ul>Attempt to impersonate another user or person or use the username of another user.</ul>
            <ul>
            ...
            <ul>Use a buying agent or purchasing agent to make purchases on the Site.</ul>
            <ul>
            ...
            <p>
                ...
                third-party websites. As such, any Contributions you transmit may be treated in accordance with the Site
                Privacy Policy. When you create or make available any Contributions, you thereby represent and warrant
                that:
            </p>
            <ul>
            ...
            <ul>Your Contributions are not false, inaccurate, or misleading.</ul>
            <ul>
            ...
            <ul>Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.</ul>
            <ul>
            ...
            <ul>Your Contributions do not violate any applicable law, regulation, or rule.</ul>
            <ul>Your Contributions do not violate the privacy or publicity rights of any third party.</ul>
            <ul>
            ...
            <p>
                ...
                Use. You shall not: (1) except as permitted by applicable law, decompile, reverse engineer, disassemble,
            ...
            <p>
                ...
                lawful purpose, commercial or otherwise, without acknowledgment or compensation to you. You hereby waive
                all moral rights to any such Submissions, and you hereby warrant that any such Submissions are original
                with you or that you have the right to submit such Submissions. You agree there shall be no recourse
            ...
            <p>
                ...
                not responsible for any Third-Party Websites accessed through the Site or any Third-Party Content posted
                ...
                Third-Party Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If
                you decide to leave the Site and access the Third-Party Websites or to use or install any Third-Party
                ...
                Site. Any purchases you make through Third-Party Websites will be through other websites and from other
                ...
                products or services offered on Third-Party Websites and you shall hold us harmless from any harm caused
                by your purchase of such products or services. Additionally, you shall hold us harmless from any losses
            ...
            <p>
                ...
                https://www.codelance.ch/privacy-policy. By using the Site, you agree to be bound by our Privacy Policy,
                which is incorporated into these Terms of Use. Please be advised the Site is hosted in Switzerland. If
                you access the Site from any other region of the world with laws or other requirements governing
                personal data collection, use, or disclosure that differ from applicable laws in Switzerland, then
                through your continued use of the Site, you are transferring your data to Switzerland, and you agree to
            ...
            <p>
                ...
                provided to you by obligatory provisions of the law of your country of residence. Codelance GmbH and
                yourself both agree to submit to the non-exclusive jurisdiction of the courts of 6340 Baar, Zug, which
                means that you may make a claim to defend your consumer protection rights in regards to these Terms of
            ...
            <p>
                ...
                or arising out of: (1) use of the Site; (2) breach of these Terms of Use; (3) any breach of your
