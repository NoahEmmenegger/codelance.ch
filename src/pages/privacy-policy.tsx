...
export default function PrivacyPolicy() {
    return (
        <div className="p-10 lg:px-52">
            <h1 className="my-10 text-5xl">Privacy Policy for Codelance GmbH</h1>

            <p>
                At codelance.ch, accessible from https://www.codelance.ch/, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded
                by codelance.ch and how we use it.
            </p>
            ...
            <p>
                ...
                regards to the information that they shared and/or collect in codelance.ch. This policy is not
            ...
            <h2 className="my-5 text-3xl">Consent</h2>

            <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

            <h2 className="my-5 text-3xl">Information we collect</h2>
            ...
            <h2 className="my-5 text-3xl">How we use your information</h2>
            ...
            <h2 className="my-5 text-3xl">Log Files</h2>

            <p>
                codelance.ch follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <h2 className="my-5 text-3xl">Cookies and Web Beacons</h2>

            <p>
                Like any other website, codelance.ch uses &apos;cookies&apos;. These cookies are used to store
            ...
            <h2 className="my-5 text-3xl">Advertising Partners Privacy Policies</h2>
            ...
            <p>
                ...
                are used in their respective advertisements and links that appear on codelance.ch, which are sent
            ...
            <p>
                Note that codelance.ch has no access to or control over these cookies that are used by third-party
                advertisers.
            </p>

            <h2 className="my-5 text-3xl">Third Party Privacy Policies</h2>

            <p>
                codelance.ch&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <h2 className="my-5 text-3xl">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
            ...
            <h2 className="my-5 text-3xl">GDPR Data Protection Rights</h2>
            ...
            <h2 className="my-5 text-3xl">Children&apos;s Information</h2>
            ...
            <p>
                codelance.ch does not knowingly collect any Personal Identifiable Information from children under the
