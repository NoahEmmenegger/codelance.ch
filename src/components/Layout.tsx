    ...
    return (
        <div className={`overflow-hidden`}>
            <Head>
                ...
                <meta property="og:image" content="https://www.codelance.ch/images/HomeImage.svg" />
                <meta property="twitter:card" content="Codelance GmbH" />
                <meta property="twitter:title" content="Codelance GmbH" />
                <meta property="twitter:description" content="Codelance GmbH" />
                <meta property="twitter:image" content="https://www.codelance.ch/images/HomeImage.svg" />
            </Head>
            <Header />
            <main>{children}</main>
            <Footer />
